...
//        setLibrarySourceLink();
    ...
    private void initComponents() {
        ...
        programNameLabel.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        ...
        versionLabel.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        ...
        homeLinkLabel.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        ...
        mortgageLinkLabel.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        ...
        jLabel5.setText("1. LibraryName: ");
        jPanel7.add(jLabel5);

        zXingLinkLabel.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        zXingLinkLabel.setText("jLabel5");
        zXingLinkLabel.setHorizontalTextPosition(javax.swing.SwingConstants.LEFT);
        jPanel7.add(zXingLinkLabel);
...
//    private void setLibrarySourceLink() {
//        final String imageLink = "https://github.com/zxing/zxing";
...
//                                </html>
//                                """;
//        zXingLinkLabel.setText(githubLink);
//        zXingLinkLabel.setCursor(new Cursor(Cursor.HAND_CURSOR));
//        zXingLinkLabel.addMouseListener(new MouseAdapter() {
//            @Override
//            public void mouseClicked(MouseEvent e) {
//                try {
//                    Desktop.getDesktop().browse(new URI(imageLink));
